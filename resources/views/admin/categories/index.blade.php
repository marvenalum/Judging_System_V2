...
<div class="page">
  ...
  <div class="topbar">
    <div class="topbar-left">
      ...
      <p>Manage and organize your content categories</p>
    </div>
          ...
          <tr style="animation-delay: {{ $index * 0.05 }}s">
            ...
            <td>
              <div class="weight-wrap">
                ...
                <div class="weight-bar"><div class="weight-fill" style="width:{{ $category->percentage_weight ?? $category->weight ?? 0 }}%"></div>
              </div>
            </td>
            <td>
            ...
            <td>
              <div class="actions">
                <a href="{{ route('admin.category.edit', $category->id) }}" class="btn-icon btn-edit">
                ...
                <form method="POST" action="{{ route('admin.category.destroy', $category->id) }}" style="display:inline;">
                  @csrf
                  @method('DELETE')
                  <button type="submit" class="btn-icon btn-delete" onclick="return confirm('Are you sure you want to delete this category?')">
          ...
          <tr>
            <td colspan="6">
              <div class="empty">
                ...
                <p>No categories found. <a href="{{ route('admin.category.create') }}" style="color: var(--accent); text-decoration: none;">Create one</a></p>
              </div>
            </td>
          </tr>
          @endforelse
