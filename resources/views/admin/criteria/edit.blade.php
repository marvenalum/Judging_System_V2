            ...
            <div class="flex">
                ...
                <div class="flex-1 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h1 class="text-2xl font-bold mb-4">Edit Criterion</h1>
                        ...
                        <form action="{{ route('admin.criteria.update', $criteria) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $criteria->name) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            </div>

                            <div class="mb-4">
                                <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                                <textarea name="description" id="description" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('description', $criteria->description) }}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="max_score" id="max_score" value="{{ old('max_score', $criteria->max_score) }}" step="0.01" min="0" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div>

                            <div class="mb-4">
                                <label for="percentage_weight" class="block text-sm font-medium text-gray-700">Percentage Weight</label>
                                <input type="number" name="percentage_weight" id="percentage_weight" value="{{ old('percentage_weight', $criteria->percentage_weight) }}" step="0.01" min="0" max="100" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div>
