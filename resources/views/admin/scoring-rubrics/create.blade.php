    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Create Scoring Rubric</h1>
            ...
            <form method="POST" action="{{ route('admin.scoring-rubrics.store') }}">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="detailed_criteria" id="detailed_criteria" rows="5"
                              class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('detailed_criteria') border-red-500 @enderror">{{ old('detailed_criteria') }}</textarea>
