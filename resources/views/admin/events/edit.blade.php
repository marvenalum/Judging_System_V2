        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-100">
                <div class="p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                    <h3 class="text-xl font-bold text-gray-900">Edit Event Details</h3>
                    <p class="mt-1 text-sm text-gray-600">Update the information for this event</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.event.update', $event) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="event_name" class="block mt-1 w-full" type="text" name="event_name" :value="old('event_name', $event->event_name)" required autofocus autocomplete="event_name" placeholder="Enter event name" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="event_description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="event_description" rows="4" placeholder="Enter event description">{{ old('event_description', $event->event_description) }}</textarea>
                            ...
                            <div class="md:col-span-2">
                                <div class="flex items-center">
                                    <input type="checkbox" id="anonymous_judging" name="anonymous_judging" value="1"
                                           {{ old('anonymous_judging', $event->anonymous_judging) ? 'checked' : '' }}
                            ...
                            <div class="md:col-span-2" id="anonymity-level-container" style="{{ $event->anonymous_judging ? '' : 'display: none;' }}">
                                ...
                                <select id="anonymity_level" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="anonymity_level">
                                    <option value="full" {{ old('anonymity_level', $event->anonymity_level) == 'full' ? 'selected' : '' }}>Full Anonymity</option>
                                    <option value="partial" {{ old('anonymity_level', $event->anonymity_level) == 'partial' ? 'selected' : '' }}>Partial Anonymity</option>
                                </select>
