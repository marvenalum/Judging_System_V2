...
<div class="page">
  ...
  <div class="topbar">
    ...
    <div class="topbar-right">
      ...
      <a href="{{ route('judge.scoring.category') }}" class="btn-primary">
...
@if($category->status === 'active')
            ...
            <td>
              <div class="actions">
                ...
                @if($category->status === 'active')
                <a href="{{ route('judge.scoring.category', ['category_id' => $category->id]) }}" class="btn-icon" style="background: var(--green-dim); color: var(--green); border-color: rgba(34,200,135,.3);">
