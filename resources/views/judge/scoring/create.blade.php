                ...
                <div class="flex-1 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="{{ route('judge.criteria.index') }}" class="text-gray-600 hover:text-gray-900">
                                ← Back to Criteria
                            </a>
                        </div>
                        ...
                        @else
                            <form method="POST" action="{{ route('judge.criteria.storeScore', $criteria) }}">
                                ...
                                <div class="flex items-center justify-end mt-6">
                                    <a href="{{ route('judge.criteria.index') }}" class="text-gray-600 hover:text-gray-900 mr-4">
                                        Cancel
                                    </a>
