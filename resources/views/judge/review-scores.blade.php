        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold mb-4">Scoring</h1>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                        ...
                        @else
                            <form method="GET" action="{{ route('judge.criteria.createScore') }}" class="flex flex-col sm:flex-row gap-4">
                                <div class="flex-1">
                                    <select id="criteria_id" name="criterion" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    ...
                    <!-- Scores Table -->
                    <div class="mt-8">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Existing Scores</h2>
